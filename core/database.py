...
# _migrate_add_plan_item_planned_start_column() moved to core/hub_models.py
...
# --- to core/hub_models.py to keep this upstream file merge-clean. They register
# --- on this same Base via init_db()'s local `from core import hub_models`.
...
def init_db():
    ...
    """
    from core import hub_models  # noqa: F401 — register hub graph models on Base before create_all()
